...
import { createTags } from '@/app/services/authService';
                ...
                <Div className="flex flex-wrap -mx-[10px]">
                    <Div className="flex-none w-full p-[7px_10px]">
                        <Div className="flex flex-wrap items-center justify-between bg-white border-l-[4px] border-l-[#294662] rounded-[5px] shadow-[0_0_50px_#00000008] p-[15px]">
                            <h4 className='font-bold leading-[1.2] mb-0 text-[20px]'>Add New Tag</h4>
                        </Div>
                    </Div>
                </Div>
            </Div>
                    ...
                    <Div className="flex flex-wrap w-full pb-[16px] pt-[16px] px-[10px] border-b-[14px] border-[#f8f8f8]">
                        <Div className="w-1/2 px-[10px]">
                            <Div className="mb-[15px]">
                                ...
                                <input className="block w-full border border-[#dddddd] rounded-[3px] px-[10px] py-[8px] leading-[1.4] text-[14px] font-normal font-inherit outline-none" type="text" {...register("tagname", { required: 'This field is required' })} />
                        ...
                        <Div className="w-1/2 px-[10px]">
                            <Div className="mb-[15px]">
                                ...
                                <input className="block w-full border border-[#dddddd] rounded-[3px] px-[10px] py-[8px] leading-[1.4] text-[14px] font-normal font-inherit outline-none" type="text" {...register("taghindiname")} />
                            </Div>
                        </Div>
                        <Div className="w-1/2 px-[10px]">
                            <Div className="mb-[15px]">
                        ...
                        <Div className="w-1/2 px-[10px]">
                            <Div className="mb-[15px]">
                                ...
                                <input className="block w-full border border-[#dddddd] rounded-[3px] px-[10px] py-[8px] leading-[1.4] text-[14px] font-normal font-inherit outline-none" type="text" {...register("tagurl", { required: 'This field is required1' })} />
