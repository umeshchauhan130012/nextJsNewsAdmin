"use client";
import { createFMenu } from "@/app/services/authService";
...
export default function AddFooterMenu() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
       await createFMenu("/footermenu", payload);
        ...
        <Div className="flex flex-wrap -mx-[10px]">
            <Div className="flex-none w-full p-[7px_10px]">
                <Div className="flex flex-wrap items-center justify-between bg-white border-l-[4px] border-l-[#294662] rounded-[5px] shadow-[0_0_50px_#00000008] p-[15px]">
                    <h4 className='font-bold leading-[1.2] mb-0 text-[20px]'>Add Footer Menu</h4>
                </Div>
            </Div>
        </Div>
    </Div>
